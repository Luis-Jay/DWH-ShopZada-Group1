-- Add ROAS (Return on Ad Spend) functionality to ShopZada Data Warehouse
...
GRANT SELECT ON presentation.view_campaign_effectiveness TO shopzada_readonly;
GRANT SELECT ON presentation.view_campaign_roas_summary TO shopzada_readonly;
GRANT SELECT ON presentation.view_monthly_roas TO shopzada_readonly;
