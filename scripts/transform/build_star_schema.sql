...
-- Orchestrates the creation of all dimensions and facts for the ShopZada DWH
...
COMMENT ON DATABASE shopzada_dwh IS 'ShopZada Kimball star schema data warehouse - Built on ' || CURRENT_TIMESTAMP;
