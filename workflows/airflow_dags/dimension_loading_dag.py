"""
ShopZada Data Warehouse - Dimension Loading DAG
...
@dag(
    dag_id='shopzada_dimension_loading',
    default_args=DEFAULT_ARGS,
    description='Load all dimension tables in the warehouse',
    schedule_interval=None,  # Manual only
    tags=['shopzada', 'dimensions', 'warehouse'],
    catchup=False,
    max_active_runs=1,
...
def dimension_loading():
    """
    Dimension loading DAG for ShopZada DWH
    """
