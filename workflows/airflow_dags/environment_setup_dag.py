"""
ShopZada Data Warehouse - Environment Setup DAG
...
@dag(
    dag_id='shopzada_environment_setup',
    default_args=DEFAULT_ARGS,
    description='Environment setup for ShopZada Data Warehouse',
    schedule_interval=None,  # Manual only
    tags=['shopzada', 'setup', 'infrastructure'],
    catchup=False,
    max_active_runs=1,
...
def environment_setup():
    """
    Environment setup DAG for ShopZada DWH
    """
